...
class ProfessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profession" do
    assert_difference('Profession.count') do
      post professions_url, params: { profession: { name: @profession.name, profession_type_id: @profession.profession_type_id } }
    end
  ...
  test "should update profession" do
    patch profession_url(@profession), params: { profession: { name: @profession.name, profession_type_id: @profession.profession_type_id } }
